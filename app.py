...
if selected_group == "✈️ 3/4수송 대시보드":
    ...
    with tab_34_4:
        ...
        with st.expander("🔍 **단체실적 검색 피벗 슬라이서 필터 설정**", expanded=True):
            ...
            sel_g_al_str = render_slicer_box(gf_col6, "6. 항공사", all_g_al, "slicer_al_grp")
        ...
        if not df_grp_filtered.empty and 'Travel Agency Name' in df_grp_filtered.columns and 'Date_Obj' in df_grp_filtered.columns:
            ...
            st.markdown(f"##### 📌 항공사별 단체 실적 (출발일 기준 상위 100개 대리점)")
...
# ==========================================
    ...
    def prepare_6th_freedom_dataset(df_in):
        ...
        col_map_6th = {
            ...
            'Sub-Route': ['Sub-Route', '소노선', 'Sub Route', 'SUB_ROUTE', 'SUBROUTE'],
    ...
    with st.expander("🔍 **6수송 대시보드 피벗 슬라이서 필터 설정**", expanded=True):
        ...
        sel_6_al = render_slicer_box(c6_d4, "9. 항공사", sorted_6th_airlines, "slicer_al_6")
